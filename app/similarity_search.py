...
# Metadata filtering
# --------------------------------------------------------------
# Using metadata_filter - a simpler way to filter results compared to the previous examples
# that only used search without any filtering. This ensures we only get shipping-related
# results rather than potentially irrelevant matches.
...
# --------------------------------------------------------------
#Same thing as metadata_filter "created_at", but for time-based filtering.
